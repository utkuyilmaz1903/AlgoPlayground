# AlgoPlayground
A Java playground for core data structures and algorithms, featuring from-scratch implementations and a simple CLI demo.

AlgoPlayground is a small but solid Java (17) project that implements core data structures and algorithms from scratch (no Java Collections for core logic), with a simple CLI demo and unit tests.
